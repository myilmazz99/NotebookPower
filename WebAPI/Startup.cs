...
namespace WebAPI
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerService logger, UserManager<ApplicationUser> userManager, ICartService cartService)
        {
            ...
            app.UseCors(conf => conf.SetIsOriginAllowed(x => _ = true).WithOrigins("https://wonderful-dune-027900103.azurestaticapps.net").AllowAnyMethod().AllowAnyHeader().AllowCredentials());
